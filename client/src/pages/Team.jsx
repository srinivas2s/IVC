                        ...
                        {row.map((member, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`p-4 bg-[#050505] border border-gray-800 rounded-2xl hover:border-ivc-primary transition-all duration-300 hover:shadow-[0_0_20px_rgba(124,58,237,0.15)] flex flex-col items-center ${cardWidth}`}
                                >
